package com.xiajun.view.progressbar;
...
import com.xiajun.lib_custom_view.R;
...
public class CircleArcProgressBar extends BaseProgressBar {
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        setMax(attributes.getInt(R.styleable.ArcProgress_arc_max, BaseProgressBar.DEFAULT_MAX));
