package com.xiajun.view.healthy;
...
public class TemperatureLineBg extends View {
    ...
    public TemperatureLineBg(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        yBigNumberLineWidth = dp2px(getContext(), (int) yBigNumberLineWidth);
        ySmallNumberLineWidth = dp2px(getContext(), (int) ySmallNumberLineWidth);
