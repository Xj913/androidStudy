...
import com.xiajun.app.MyApp.databinding.ActivityWeekSportBinding
import java.util.*
...
class SportWeekActivity : BaseTitleBarActivity() {
    ...
    override fun onCreate(arg0: Bundle?) {
        ...
        bd.mSportWeek.setOnSelectionChangeListener(object : com.xiajun.view.healthy.SportWeekHistogram.OnSelectionChangeListener {
    ...
    private var weekSportData: ArrayList<com.xiajun.view.healthy.SportWeekHistogram.PointItem>? = null

    private fun getData(): List<com.xiajun.view.healthy.SportWeekHistogram.PointItem> {
        val list = ArrayList<com.xiajun.view.healthy.SportWeekHistogram.PointItem>()
        var item: com.xiajun.view.healthy.SportWeekHistogram.PointItem
        val random = Random()
        for (i in 0..6) {
            item = com.xiajun.view.healthy.SportWeekHistogram.PointItem("", random.nextInt(3500) + 1000)
            list.add(item)
        }
        weekSportData = list
        return list
